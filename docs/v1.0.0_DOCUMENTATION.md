...
Use the high-level preset from `@mfe/shared/vite`. It automatically bundles React 19 singletons, Tailwind, the `federation-css-fix` plugin, and resolves ports from `remotes.manifest.json`:
```javascript
