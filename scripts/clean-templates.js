export const CLEAN_HOST_APP = `import React from "react";
...
function App() {
  return (
    <Routes>
      ...
      {/* Mount your micro-frontend routes here:
        Example:
        <Route
          path="/myService/*"
          element={
            <RemoteErrorBoundary remoteName="My Service">
              <React.Suspense fallback={<LoadingFallback message="Streaming My Service..." />}>
                <MyServiceApp />
              </React.Suspense>
            </RemoteErrorBoundary>
          }
